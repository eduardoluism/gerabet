...
function closeModal() {
    ...
    const alertas = [
        ...
        '#alerta-saldo-mais',
        '#alerta-saldo-menos',
        '#alerta-porcentagem-afiliado', '#alerta-bonuscadastro', '#alerta-afiliados', '#alerta-cancelar', '#alerta-despesas'
    ];
...
// Função forms 
    ...
    $('#formgerapix, #formplayfiver, #formvalores, #formfacebook, #formemail, #formlogo, #formfavicon, #formslider, #formnomeurl, #formcores, #formredes, #formnovojogo, #formsenha, #formconfirmar, #formsaldomais, #formsaldomenos, #formporcentagemafiliado, #formbonuscadastro, #formafiliados, #formcancelar, #formdespesas').submit(function (e) {
        e.preventDefault();
