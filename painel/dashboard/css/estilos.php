...
?>
        ...
        /* Páginas: JOGOS - PAGAMENTOS - DEPÓSITOS*/
        .jogos-table-wrapper, 
        ...
        .jogos-table th, .pagamentos-table th, .depositos-table th, .despesas-table th, 
        .jogos-table td, .pagamentos-table td, .depositos-table td, .despesas-table td {
            padding: 12px 15px;
            text-align: center;
            font-size: 14px;
